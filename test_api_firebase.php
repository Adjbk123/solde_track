...
echo "🧪 Test de l'API avec la nouvelle implémentation Firebase\n";
echo "======================================================\n\n";

$baseUrl = 'http://localhost/solde-track-api/public/index.php';
...
echo "3️⃣ Test de l'endpoint de motivation...\n";
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, $baseUrl . '/api/notifications/motivation');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
curl_setopt($ch, CURLOPT_POST, true);
curl_setopt($ch, CURLOPT_HTTPHEADER, [
    'Authorization: Bearer ' . $token,
